...
export default function CustomSVGRootLevelComponent(props) {
    ...
    const updateMousePosition = ev => {
        setMousePosition({ x: ev.clientX - 47, y: ev.clientY - 18 });
    };
    ...
    const customComponent = (row, positionInPixels) => {
        return (
            <g className="inner-inner-component">
                ...
                <svg>
                    <image href={row.url} width={80} height={30}/>
                </svg>
        ...
        <React.Fragment>
            ...
            >
                ...
                <CustomSVGSeries
                    ...
                    data={[
                        {x: 0, y: 0, size: 0, disable: true},
                        {x: 5, y: 20, size:0, disable: true},
                    ...
                    onNearestXY={(a, cord) => {
                        const x = mousePosition.x > cord.innerX && mousePosition.x < cord.innerX + 83
                        const y = mousePosition.y > cord.innerY && mousePosition.y < cord.innerY + 33
